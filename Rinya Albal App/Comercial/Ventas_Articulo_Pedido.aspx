<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_Articulo_Pedido.aspx.cs" Inherits="Rinya_Albal_App.Comercial.Ventas_Articulo_Pedido" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  if (!($("[id$=datepicker1]").datepicker().attr("Value") == undefined)) {
    ...
    <div class="row">
        <div class="col-md-8">
            <h2>Informe Ventas Articulo Pedido</h2>

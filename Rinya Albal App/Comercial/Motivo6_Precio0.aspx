<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Motivo6_Precio0.aspx.cs" Inherits="Rinya_Albal_App.Comercial.Motivo6_Precio0" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  if (!($("[id$=datepicker1]").datepicker().attr("Value") == undefined)) {
     ...
     <div class="row">
           <div class="col-md-8">
               <h2> Informe Albaranes con precio 0</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                         ...
                         <asp:TextBox ID="datepicker1" CssClass="form-control"  runat="server" EnableViewState="true" style="width: 98px"></asp:TextBox>
                         <!-- </div>-->
                  
                    </div>

                    <div class="col-md-2">
                        <asp:TextBox ID="datepicker2" CssClass="form-control"  runat="server" EnableViewState="true" style="width: 98px"></asp:TextBox>
                        </div>

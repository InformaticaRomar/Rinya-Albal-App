<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ventas_volumen_romar.aspx.cs" Inherits="Rinya_Albal_App.Comercial.Ventas_volumen_romar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   semana_dia.setMonth(semana_dia.getMonth() - 1);
  ...
  if (!($("[id$=datepicker1]").datepicker().attr("Value") == undefined)) {
    ...
    <div class="row">
        <div class="col-md-8">
            <h2>Ventas por Volumen Romar</h2>
